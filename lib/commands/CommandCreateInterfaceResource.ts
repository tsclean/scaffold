...
export class CommandCreateInterfaceResource implements yargs.CommandModule {
    ...
    async handler(args: yargs.Arguments) {
        ...
        try {
            const fileContent = CommandCreateInterfaceResource.getTemplateInterface(args.name as any)
...
export const ${toUpperCase}_RESOURCE_REPOSITORY = "${toUpperCase}_RESOURCE_REPOSITORY";
